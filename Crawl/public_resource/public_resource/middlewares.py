...
class PublicResourceSpiderMiddleware(object):
...
class PublicResourceDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
    ...
    #
    #     ip_data = ip_data['data'][0]
    #     self.t1 = int(time.time())
    #     self.ip = 'http://{}:{}'.format(ip_data['IP'], ip_data['Port'])
