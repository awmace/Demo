...
if __name__ == '__main__':
    url = 'https://www.cnblogs.com/yuan-x/p/12361500.html'
    # redata = 'OWFhODUxNmZjNTE2MDA0YzUwNWVkNDU3ZjVkMTUzMjVhYjk0NWFkNTgyMTNhZjAzM2IzNjVjYjAyYWIxZjE4OWI5MjBlYjRiMmY4NzljMTY1Yzc4MmZjZTI0MjQ0OTU3YjJjODE0MTJiZTVm'
    # url = '4343434'
    redata = 'OWFhODUxNmZjNTE2MDA0YzUwNWVkNDU3ZjVkMTUzMjVhYjk0NWFkNTgyMTNhZjAzM2IzNjVjYjAyYWIxZjE4OWI5MjBlYjRiMmY4NzljMTY1Yzc4MmZjZTI0MjQ0OTU3YjJjODE0MTJiZTVmM2RiN2M1NTJiNzgwYTBjNjUwMzQ4YmE3YmU3MmI1NjIyY2NmMjE3NjljY2RlODI1OWU5MQ=='
    pc = PrpCrypt('daajanbaqa654321', '1234567890123456')
    # redata = pc.encrypt(url)
    # print(redata)
